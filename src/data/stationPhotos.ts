...
export const stationPhotos: StationPhoto[] = [
  ...
  },
  {
    ...
    caption: {
      ...
      ru: "Район Sukhumvit Road рядом с местом посадки на автобус в Паттайе. Подтвердите точную остановку перед поездкой.",
      th: "พื้นที่ถนนสุขุมวิทในพัทยา ใกล้จุดขึ้นรถบัส โปรดยืนยันจุดขึ้นรถก่อนเดินทาง",
    },
    alt: {
      en: "Sukhumvit Road in Pattaya near the bus boarding area.",
      pl: "Sukhumvit Road w Pattayi w pobliżu strefy odjazdu autobusu.",
      th: "ถนนสุขุมวิทในพัทยา ใกล้จุดขึ้นรถบัส",
    },
    author: "Vmenkov",
  ...
  },
  {
    ...
    caption: {
      ...
      ru: "Сонгтэо на Sukhumvit Road в Паттайе. Места посадки могут меняться, проверьте точную остановку.",
      th: "สองแถวบนถนนสุขุมวิทในพัทยา จุดรับอาจเปลี่ยนได้ โปรดตรวจสอบจุดที่แน่นอน",
    },
    alt: {
      en: "Songthaew vehicle on Sukhumvit Road in Pattaya.",
      pl: "Songthaew na Sukhumvit Road w Pattayi.",
      th: "รถสองแถวบนถนนสุขุมวิทในพัทยา",
    },
    author: "Ilya Plekhanov",
  ...
  },
  {
    ...
    caption: {
      ...
      ru: "Местный транспорт на Sukhumvit Road в Паттайе. Используйте фото для ориентира, а не как подтвержденный перрон.",
      th: "รถท้องถิ่นบนถนนสุขุมวิทในพัทยา ใช้ภาพนี้เพื่อจำบรรยากาศพื้นที่ ไม่ใช่ชานชาลาที่ยืนยันแล้ว",
    },
    alt: {
      en: "Local songthaew transport on Sukhumvit Road in Pattaya.",
      pl: "Lokalny songthaew na Sukhumvit Road w Pattayi.",
      th: "รถสองแถวท้องถิ่นบนถนนสุขุมวิทในพัทยา",
    },
    author: "Ilya Plekhanov",
