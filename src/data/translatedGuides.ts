...
export const translatedGuideLocales: Record<string, LocaleCode[]> = {
  ...
  "bangkok-to-pattaya-bus-fare": ["zh", "ru"],
...
> = {
  ...
  "bangkok-to-pattaya-bus-fare": { zh: "2026-09-16", ru: "2026-09-16" },
  "jomtien-bus-station": { zh: "2026-08-23", ru: "2026-07-17" },
  "don-mueang-airport-to-pattaya-bus": { zh: "2026-09-16" },
  "pattaya-to-don-mueang-airport-bus": { zh: "2026-09-16" },
  "pattaya-to-suvarnabhumi-airport-before-flight": { zh: "2026-09-16" },
  "suvarnabhumi-airport-gate-8-pattaya-bus": { zh: "2026-09-16" },
  "pattaya-to-suvarnabhumi-which-station": { zh: "2026-09-16" },
  "bangkok-to-pattaya-bus-vs-taxi": { zh: "2026-09-16" },
  "bangkok-to-pattaya-after-midnight": { zh: "2026-08-24" },
  "pattaya-to-bangkok-before-flight": { zh: "2026-09-16" },
  "mo-chit-bus-terminal-to-pattaya": { zh: "2026-08-23" },
  "pattaya-bus-station-to-jomtien": { zh: "2026-09-16" },
