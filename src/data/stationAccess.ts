...
const germanStationAccessGuides: Record<RouteId, PlainStationAccessGuide> = {
  ...
  "suvarnabhumi-airport-to-pattaya": {
    ...
    items: [
      ...
      "Tipp: Dieser Hinweis betrifft die separate stündliche Verbindung Suvarnabhumi–Jomtien ab 158 THB, nicht den auf dieser Seite beschriebenen Bus ab 135 THB. Deren Abfahrt um 22:00 endet am Busbahnhof Pattaya und hält nicht in Jomtien. Beide Verbindungen fahren im selben Bereich bei Gate 8 ab; bestätige daher die Route am Schalter."
    ],
    note: germanTransportPriceNote
  },
...
export const stationAccessGuides: Record<RouteId, StationAccessGuide> = {
  ...
  "suvarnabhumi-airport-to-pattaya": {
    ...
    items: [
      ...
      {
        en: "Tip: This note concerns the separate hourly Suvarnabhumi-Jomtien service from 158 THB, not the bus described on this page (from 135 THB). Its 22:00 departure terminates at Pattaya Bus Station and does not stop at Jomtien. Both services leave from the same Gate 8 area, so confirm your route at the counter.",
        pl: "Wskazówka: Ta uwaga dotyczy osobnej, kursującej co godzinę linii Suvarnabhumi–Jomtien od 158 THB, a nie opisanego na tej stronie autobusu od 135 THB. Jej kurs o 22:00 kończy bieg na dworcu w Pattayi i nie zatrzymuje się w Jomtien. Obie linie odjeżdżają z tego samego stanowiska przy Gate 8, więc potwierdź kierunek przy kasie.",
        ru: "Совет: это примечание относится к отдельному ежечасному маршруту Суварнабхуми — Джомтьен от 158 бат, а не к автобусу от 135 бат, описанному на этой странице. Его рейс в 22:00 заканчивается на автовокзале Паттайи и не заезжает в Джомтьен. Оба маршрута отправляются из одной зоны у выхода 8, поэтому уточните направление в кассе.",
        th: "คำแนะนำ: ข้อความนี้ใช้กับบริการสุวรรณภูมิ–จอมเทียนแยกต่างหากที่ออกทุกชั่วโมง ราคาเริ่มต้น 158 บาท ไม่ใช่รถราคาเริ่มต้น 135 บาทที่อธิบายในหน้านี้ เที่ยวเวลา 22:00 สิ้นสุดที่สถานีขนส่งพัทยาและไม่จอดที่สถานีขนส่งจอมเทียน รถทั้งสองบริการออกจากบริเวณเดียวกันใกล้ประตู 8 ดังนั้นโปรดยืนยันเส้นทางที่เคาน์เตอร์",
      },
    ],
    note: transportPriceNote,
  },
