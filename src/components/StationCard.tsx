...
const suvarnabhumiArrivalBusTips: Record<LocaleCode, string[]> = {
  en: [
    ...
    "Show your passport or booking, buy or collect the ticket, and confirm the destination. Jomtien is served by a separate hourly service from 158 THB (the bus on this page costs from 135 THB); its 22:00 trip terminates at Pattaya Bus Station and does not stop at Jomtien.",
  ...
  pl: [
    ...
    "Pokaż paszport lub rezerwację, kup albo odbierz bilet i potwierdź kierunek. Do Jomtien kursuje osobna, godzinna linia od 158 THB (autobus z tej strony kosztuje od 135 THB); jej kurs o 22:00 kończy bieg na dworcu w Pattayi i nie zatrzymuje się w Jomtien.",
  ...
  de: [
    ...
    "Zeige Pass oder Buchung, kaufe oder hole dein Ticket ab und bestätige das Ziel. Nach Jomtien fährt eine separate stündliche Linie ab 158 THB (der Bus auf dieser Seite kostet ab 135 THB); deren Fahrt um 22:00 endet am Busbahnhof Pattaya und hält nicht in Jomtien.",
  ...
  fr: [
    ...
    "Présentez votre passeport ou réservation, achetez ou retirez le billet et confirmez la destination. Un service distinct dessert Jomtien toutes les heures à partir de 158 THB (le bus de cette page coûte à partir de 135 THB) ; son départ de 22:00 termine à la gare routière de Pattaya sans desservir Jomtien.",
  ...
  ru: [
    ...
    "Покажите паспорт или бронь, купите или получите билет и уточните направление. В Джомтьен ходит отдельный ежечасный автобус от 158 бат (автобус на этой странице стоит от 135 бат); его рейс в 22:00 заканчивается на автовокзале Паттайи и не заезжает в Джомтьен.",
  ...
  th: [
    ...
    "แสดงพาสปอร์ตหรือข้อมูลการจอง ซื้อตั๋วหรือรับตั๋ว และยืนยันปลายทาง รถไปจอมเทียนเป็นบริการแยกที่ออกทุกชั่วโมง ราคาเริ่มต้น 158 บาท (รถในหน้านี้ราคาเริ่มต้น 135 บาท) โดยเที่ยว 22:00 สิ้นสุดที่สถานีขนส่งพัทยาและไม่จอดจอมเทียน",
  ...
  zh: [
    ...
    "出示护照或预订信息，购买或领取车票，并确认目的地。前往 Jomtien 的是每小时一班、票价 158 THB 起的独立线路（本页巴士票价 135 THB 起）；其 22:00 班次终到 Pattaya Bus Station，不停靠 Jomtien。",
