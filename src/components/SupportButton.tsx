...
export function SupportButton({ labels }: SupportButtonProps) {
  return (
    <section className="rounded-2xl border border-[#c8dbe9] bg-white p-3.5 text-[#13233a] shadow-sm sm:flex sm:items-center sm:justify-between sm:gap-6 sm:p-5">
      <div>
        <p className="text-xs font-bold uppercase tracking-wide text-[#2f6f93] sm:text-sm">
          {labels.title}
        </p>
        <h2 className="mt-1 text-lg font-black leading-tight sm:mt-2 sm:text-2xl">
          {labels.question}
        </h2>
      </div>
      <a
