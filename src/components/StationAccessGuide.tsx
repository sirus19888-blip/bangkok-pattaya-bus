...
export function StationAccessGuide({
  ...
  return (
    <section className="rounded-2xl border border-[#eadcc7] bg-[#fffaf2] p-3 shadow-sm sm:p-5 lg:p-3.5">
      ...
      <div className="mt-3 grid gap-2 lg:mt-2.5">
        {items.map((item, index) => (
          <div
            key={item}
            className="flex gap-3 rounded-2xl border border-[#eadcc7] bg-white px-3 py-2.5 text-sm font-semibold leading-6 text-[#4f5d6c] lg:gap-2.5 lg:py-2 lg:text-xs lg:leading-5"
          >
